...
import com.pdfmerge.proapp2022.pdfmerge.PDFEditor.PDFEditorActivity;
import com.pdfmerge.proapp2022.pdfmerge.Utility.FileUtils;
import com.pdfmerge.proapp2022.pdfmerge.Utility.MyBounceInterpolator;
...
import com.pdfmerge.proapp2022.pdfmerge.DataAdapter.MainRecycleViewAdapter;
import com.pdfmerge.proapp2022.pdfmerge.DataAdapter.SpacingItemDecoration;
...
public class Main2Activity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InterstitialAd.load(this,"ca-app-pub-3389769914405265/5366741394", adRequest,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_rateapp) {
            ...
            Intent goToMarket = new Intent(Intent.ACTION_VIEW, Uri.parse("market://search?q=pub:Binary+Devs"));
            goToMarket.addFlags(Intent.FLAG_ACTIVITY_NO_HISTORY |
                    Intent.FLAG_ACTIVITY_NEW_DOCUMENT |
                    Intent.FLAG_ACTIVITY_MULTIPLE_TASK);
            try {
                ...
                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com/store/apps/developer?id=Binary+Devs")));
            }
            return true;
        } else if (id == R.id.action_tell) {
            Intent sendIntent = new Intent();
            sendIntent.setAction(Intent.ACTION_SEND);
            sendIntent.putExtra(Intent.EXTRA_TEXT, "I am using PDF Editor tool to merge PDF,JPEG,PNG and HTML into single PDF. Download Now https://play.google.com/store/apps/details?id=" + getPackageName());
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.home) {
            ...
            Email.putExtra(Intent.EXTRA_EMAIL, new String[]{"meanshul42@gmail.com"});
