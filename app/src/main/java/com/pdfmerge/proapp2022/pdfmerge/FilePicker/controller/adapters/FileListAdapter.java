package com.pdfmerge.proapp2022.pdfmerge.FilePicker.controller.adapters;
...
import com.pdfmerge.proapp2022.pdfmerge.FilePicker.widget.OnCheckedChangeListener;
...
public class FileListAdapter extends BaseAdapter{
    ...
    public NotifyItemChecked notifyItemChecked;
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (item.isDirectory()) {
            holder.type_icon.setImageResource(R.drawable.ic_folder_black_24dp);
            ...
            holder.type_icon.setImageResource(R.drawable.ic_insert_drive_file_black_24dp);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
